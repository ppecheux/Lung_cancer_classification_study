...
Consider a nodetwith sizentwith impurityQtFor some variablejand split points, we splittin two nodes,tLandtR, with sizesntLandntR, and with impuritiesQtLandQtRThe average decrease of impurity is∆(j,s) =Qt−(ntLntQtL+ntRntQtR)IfQtis the entropy, then∆(j,s)is interpreted as an information gain.We select at each step the splitting variablejand the split pointsthatmaximizes∆(j,s)or, equivalently, that minimizes the average impurityntLntQtL+ntRntQ
